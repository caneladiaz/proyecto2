...
public class frmMostrarcliente extends javax.swing.JFrame {
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        ...
        if (evt.getClickCount() == 2) {//si hace doble click
            ...
            ap = tblRegistro.getValueAt(fila, 2).toString();

            if (frm_agendamiento.txtidCliente != null && frm_agendamiento.txtidCliente != null) {
                frm_agendamiento.txtidCliente.setText(cod);
                frm_agendamiento.txtcliente.setText(valor);
                frm_agendamiento.txtapellido_cliente.setText(ap);
            }

            if (frm_facturaVenta.txtidCliente != null && frm_facturaVenta.txtIdEmpleado != null) {
//                String valor1;
//                valor1 = tblRegistro.getValueAt(fila, 3).toString();
                frm_facturaVenta.txtidCliente.setText(cod);
                frm_facturaVenta.txtcliente.setText(valor);
//                frm_facturaVenta.txtapellido_cliente.setText(ap);
            }
            dispose();
        }
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMostrarcliente.class  
