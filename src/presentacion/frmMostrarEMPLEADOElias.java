 ...
 * @author admin
 */
public class frmMostrarEMPLEADOElias extends javax.swing.JFrame {

    /**
     * Creates new form frmMostrarEMPLEADOElias
     */
    public frmMostrarEMPLEADOElias() {
        initComponents();
        mostrar("");
    }
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        ...
        if (evt.getClickCount() == 2) {//si hace doble click
            ...
            valor = tblRegistro.getValueAt(fila, 3).toString();

            if (FRM_pedidos_compras.txtIdEmpleado != null &&  FRM_pedidos_compras.txtIdEmpleado != null) {
                FRM_pedidos_compras.txtIdEmpleado.setText(cod);
                FRM_pedidos_compras.txtEmpleado.setText(valor);
            }

            if (frm_agendamiento.txtidempleado != null && frm_agendamiento.txtidempleado != null) {
                frm_agendamiento.txtidempleado.setText(cod);
                frm_agendamiento.txtEmpleado.setText(valor);
            }
//
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMostrarEMPLEADOElias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMostrarEMPLEADOElias().setVisible(true);
            }
        });
    }
