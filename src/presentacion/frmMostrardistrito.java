 ...
 * @author admin
 */
public class frmMostrardistrito extends javax.swing.JFrame {

    /**
     * Creates new form frmdistrito
     */
    public frmMostrardistrito() {
        initComponents();
         mostrar("");
    }
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        ...
        if (evt.getClickCount()==2) {//si hace doble click
            ...
            if (FRM_empleados.txtdistrito !=null && FRM_empleados.txtiddistrito != null) {
                FRM_empleados.txtiddistrito.setText(cod);
                FRM_empleados.txtdistrito.setText(valor);
            }

            if (FRM_clientes.txtdistrito !=null && FRM_clientes.txtiddistrito != null) {
                FRM_clientes.txtiddistrito.setText(cod);
                FRM_clientes.txtdistrito.setText(valor);
            }

            if (FRM_proveedor.txtdistrito !=null && FRM_proveedor.txtiddistrito != null) {
                FRM_proveedor.txtiddistrito.setText(cod);
                FRM_proveedor.txtdistrito.setText(valor);
            }
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMostrardistrito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMostrardistrito().setVisible(true);
            }
        });
    }
