 ...
 * @author admin
 */
public class frmMostrarRol extends javax.swing.JFrame {

    /**
     * Creates new form frmMostrarRol
     */
    public frmMostrarRol() {
        initComponents();
         mostrar("");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMostrarRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMostrarRol().setVisible(true);
            }
        });
    }
