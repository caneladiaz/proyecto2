...
public class frmMostrarRegion extends javax.swing.JFrame {

    /**
     * Creates new form frmMostrarRegion
     */
    public frmMostrarRegion() {
        initComponents();
        mostrar("");
    }
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        ...
        if (evt.getClickCount()==2) {//si hace doble click
            ...
            FRM_departamento.txtidregion.setText(cod);
            FRM_departamento.txtregion.setText(valor);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMostrarRegion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMostrarRegion().setVisible(true);
            }
        });
    }
