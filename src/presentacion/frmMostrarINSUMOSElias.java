 ...
 * @author admin
 */
public class frmMostrarINSUMOSElias extends javax.swing.JFrame {

    /**
     * Creates new form frmMostrarINSUMOSElias
     */
    public frmMostrarINSUMOSElias() {
        initComponents();
       mostrar("");
    }
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        ...
        if (evt.getClickCount()==2) {//si hace doble click
            ...
            String cod, valor,unidad,cant;
            cod =tblRegistro.getValueAt(fila, 0).toString();//lo del tbl es un objeto
            valor= tblRegistro.getValueAt(fila, 1).toString();
            unidad = tblRegistro.getValueAt(fila, 10).toString();
            cant = tblRegistro.getValueAt(fila, 11).toString();
            
            FRM_pedidos_compras.txtIdProducto.setText(cod);
                FRM_pedidos_compras.txtProducto.setText(valor);
                FRM_pedidos_compras.txtpresentacion.setText(unidad); 
                FRM_pedidos_compras.txtcantidad_unidad.setText(cant); 
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMostrarINSUMOSElias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMostrarINSUMOSElias().setVisible(true);
            }
        });
    }
